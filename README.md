...
Copy and paste the email content into the **Email Input** text box.
...
The application preprocesses the email text by:
...
- Transforming the text using TF-IDF

---

### Step 5

The processed email is passed to the trained **Random Forest** classifier.

---

### Step 6

The application displays the prediction results.
